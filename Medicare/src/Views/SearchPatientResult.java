    ...
    private void resetNonSelectedValues(int newRow, int col)
    {
     ...
     private void searchPatientModel(String firstName,String lastName,int nic)
     {
           try{
               ...
               cols = 5; // since our result header has 5 cols
              int rowCount=0;
            ...
            while(rs.next())
            {
                ...
                data[rowCount][1] = rs.getString(1);
                
                data[rowCount][2] = rs.getString(2);
                data[rowCount][3] = rs.getString(3);
...
public class SearchPatientResult extends javax.swing.JFrame {
    ...
    public SearchPatientResult(String firstName, String LastName, int Nic) {
        this.firstName = firstName;
        this.LastName = LastName;
        this.Nic = Nic;
